...
module.exports = {
  ...
  */
  addPageMessage(messageID, channelID, authorID, pageNumber, type, extraData) {
  ...
  */
  handlePages(reaction, user) {
    ...
    this.updateMessage(reaction.message.id, messages[reaction.message.id].type, messages[reaction.message.id].page);
  },
  /*
  ...
  updateMessage(messageID, type, page) {
    ...
    switch(type) {
      case "leaderboard":
        ...
        break;
      case "devlog":
        message.edit(util.general.getDevlog(page, messages[messageID].day));
        break;
      case "help":
        message.edit(util.general.getHelpMenu(messages[messageID].guild, message.author.id, page, messages[messageID].helpType, messages[messageID].mod));
        break;
